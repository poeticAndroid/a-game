...
editBtn.addEventListener("click", () => {
  document.body.innerHTML = `
    <a-scene physics="workerUrl:../dist/cannonWorker.js">
      ...
      <a-gltf-model src="https://cdn.glitch.com/e956e2ed-f877-4602-a395-a2e234731117%2Fguncil.glb" grabbable="physics:false;fixed:true;fixedPosition:0 0.0625 0;" position="0 1.5 -0.5" editor="gridDensity: ${document.querySelector("#densTxt").value};rotDensity: ${document.querySelector("#rotTxt").value};"></a-gltf-model>
      </a-player>
      <a-main></a-main>
    </a-scene>
  `
